...
from footprint.client.configuration.sacog.built_form.sacog_land_use_definition import (
    SacogLandUseDefinition,
)
...
class SacogInitFixture(InitFixture):
    ...
    def model_class_modules(self):
        ...
        :return:
        """
        return [("built_form", "land_use_definition"), ("built_form", "land_use")]
    ...
    def populate_models(self):
        if SacogLandUseDefinition.objects.count() == 0:
            ...
            fixture_path = os.path.join(
                ...
                "sacog",
                "built_form",
                "sacog_land_use_definitions.json",
            )
            ...
            print(
                logger.info(
                    "Skipping because of "
                    + str(SacogLandUseDefinition.objects.count())
