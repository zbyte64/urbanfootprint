...
class Job(models.Model):
    ...
    user = models.ForeignKey(
        settings.AUTH_USER_MODEL, related_name="jobs", on_delete=models.PROTECT
    )
...
def start_and_track_task(celery_task, api_key, *args, **kwargs):
    ...
    logger.info(
        "Starting celery task %s with args: %s kwargs %s", celery_task, args, kwargs
    )
